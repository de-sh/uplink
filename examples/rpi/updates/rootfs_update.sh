...
echo "{ \"sequence\": 0, \"timestamp\": $(date +%s%3N), \"action_id\": $1, \"state\": \"Completed\", \"progress\": 20, \"errors\": [] }" >& "${COPROC[1]}"
...
echo "{ \"sequence\": 0, \"timestamp\": $(date +%s%3N), \"action_id\": $1, \"state\": \"Completed\", \"progress\": 40, \"errors\": [] }" >& "${COPROC[1]}"
...
echo "{ \"sequence\": 1, \"timestamp\": $(date +%s%3N), \"action_id\": $1, \"state\": \"Completed\", \"progress\": 50, \"errors\": [] }" >& "${COPROC[1]}"
...
echo "{ \"sequence\": 2, \"timestamp\": $(date +%s%3N), \"action_id\": $1, \"state\": \"Completed\", \"progress\": 75, \"errors\": [] }" >& "${COPROC[1]}"
...
echo "{ \"sequence\": 3, \"timestamp\": $(date +%s%3N), \"action_id\": $1, \"state\": \"Completed\", \"progress\": 90, \"errors\": [] }" >& "${COPROC[1]}"
