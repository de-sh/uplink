...
# get bridge_app
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/bridge.py https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/bridge.py

# get systemd script
mkdir -pv /mnt/download/systemd
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/systemd/systemd.sh https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/systemd/systemd.sh
...
# get config.toml 
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/config.toml https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/config.toml

# get reboot.sh
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/config.toml https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/reboot.sh

# get find_root.sh
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/config.toml https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/find_root.sh
...
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/run_uplink.sh https://raw.githubusercontent.com/bytebeamio/sai-kiran-y/main/examples/rpi/run_uplink.sh
