...
# get update_fstab.sh
curl --proto '=https' --tlsv1.2 -sSf -o update_fstab.sh https://raw.githubusercontent.com/sai-kiran-y/uplink/main/examples/rpi/update_fstab.sh
...
# get startup.service
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/systemd/startup.service https://raw.githubusercontent.com/sai-kiran-y/uplink/main/examples/rpi/systemd/startup.service
...
# get startup.sh
curl --proto '=https' --tlsv1.2 -sSf -o /mnt/download/startup.sh https://raw.githubusercontent.com/sai-kiran-y/uplink/main/examples/rpi/startup.sh
